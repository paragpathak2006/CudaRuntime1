...
public:
	...
	__device__ __host__ double dist(const Point& target, const Point* points) const;
	__device__ __host__ double dist(const Point& target, const Points& points) const;
